...
class Mheader{
	...
	*/
	static function cacheControl($sec){
		if($sec<=0){
	...
	*/
	static function lastModified($sec,$iHTTP_IF_MODIFIED_SINCE=NULL){
	...
	* return : true일 경우 exit()로 페이지를 끝내는걸 추천.
	*/
	static function etag($etag,$iHTTP_IF_NONE_MATCH=NULL){
