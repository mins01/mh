...
|
*/
$config['log_path'] = dirname(dirname(dirname(__FILE__))).'/_logs/';
...
|
*/
$config['cache_path'] =  dirname(dirname(dirname(__FILE__))).'/_cache/';;
...
$config['cookie_path']		= '/';
// $config['cookie_path']      = '/; SameSite=None'; //for samesite none
