		...
		<div class="container-fluid ">
			...
			<div id="navbar" class="collapse navbar-collapse">
				...
				<div class="navbar-right">
					...
					<button type="button" class="btn btn-success btn-xs" onclick="window.open('<?=html_escape(SITE_URI_MEMBER_PREFIX.'join')?>','_self')">회원가입</button>
					<button type="button" class="btn btn-warning btn-xs" onclick="window.open('<?=html_escape(SITE_URI_MEMBER_PREFIX.'search_id')?>','_self')">계정 찾기</button>
					<button type="button" class="btn btn-primary btn-xs" onclick="window.open('<?=html_escape(SITE_URI_MEMBER_PREFIX.'login')?>','_self')">로그인</button>
					</p>
					<? else: ?>
					<p class="navbar-text text-right "><a href="<?=html_escape(SITE_URI_MEMBER_PREFIX.'user_info')?>"><span class="glyphicon glyphicon-user"></span><?=html_escape($login_label)?></a>님 <button class="btn btn-info btn-xs" onclick="window.open('<?=html_escape(SITE_URI_MEMBER_PREFIX.'logout')?>','_self')">로그아웃</button></p>
					<? endif;?>
				</div>
			</div><!--/.nav-collapse -->
		</div>
