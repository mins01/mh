...
<head>
	...
	<link rel="stylesheet" href="<?=SITE_URI_ASSET_PREFIX?>etcmodule/ui_menu/ui_menu.css?t=<?=REFLESH_TIME?>">
	<link rel="stylesheet" href="<?=SITE_URI_ASSET_PREFIX?>etcmodule/ui_menu/ui_menu_theme_01.css?t=<?=REFLESH_TIME?>">
	<script src="<?=SITE_URI_ASSET_PREFIX?>etcmodule/ui_menu/ui_menu.js?t=<?=REFLESH_TIME?>"></script>
	<script>
...
<body>
	...
	<? if(!$hide):?>
	<?
	require_once(dirname(__FILE__).'/ui_menu.php');
	?>
