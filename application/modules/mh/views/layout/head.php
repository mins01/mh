		...
		<div class="container-fluid">
			...
			<div id="navbar" class="collapse navbar-collapse">
				...
				<ul class="nav navbar-nav pull-right">
					...
					<? else: ?>
					<li><span class="navbar-text"> <a href="<?=base_url().'user_info'?>"><span class="glyphicon glyphicon-user"></span><?=html_escape($login_label)?></a>님</span> <button class="btn btn-default navbar-btn" onclick="window.open('<?=base_url().'logout'?>','_self')">로그아웃</button></li>
					<? endif;?>
				</ul>
			</div><!--/.nav-collapse -->
		</div>
